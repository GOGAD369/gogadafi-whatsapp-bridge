...
app.post('/api/send-template', authCheck, async (req, res) => {
  ...
  try {
        ...
        template: {
          ...
          components: [
            ...
            },
            {
              type: 'body',
              parameters: [
                { type: 'text', text: referredBy || 'our team' }
              ]
            }
          ]
        }
    ...
    await saveMessage({
      customerPhone: phone,
      customerName: customerName || 'Unknown',
      text: `[Template: intern_recruiting] Hi ${customerName || 'there'}! You were referred by ${referredBy || 'our team'}.`,
      direction: 'outgoing',
